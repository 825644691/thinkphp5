...
<head lang="en">
    <meta charset="UTF-8">
    <title></title>
    <link href="/lab8/Public/CSS/bootstrap.min.css" rel="stylesheet" type="text/css">
    <script src="/lab8/Public/JS/jquery-1.6.2.min.js"></script>
    <style>
        body,div,table{
            margin: 10px auto;
            text-align: center;
...
<body>
    ...
    <div class="aa">
        ...
        <a href="/lab8/index.php/Home/Index/addMsg">新增留言</a>
    </div>
    <div class="aa">
        查询
    ...
    <div id="content">
        <table class="table table-striped">
            ...
            <?php if(is_array($msg)): $i = 0; $__LIST__ = $msg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$msg): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="/lab8/index.php/Home/Index/edit?id=<?php echo ($msg["id"]); ?>">修改</a></td>
    ...
    <script>
        ...
        function del(obj, id) {
            ...
            if(conn == true) {
                $.post('/lab8/index.php/Home/Index/deteleMsg', {id:id}, function (data) {
                    if(data == 1) {
        ...
        function queryAndOrder() {
            ...
            $.post('/lab8/index.php/Home/Index/queryAndOrder', {orderWay:way, word:word, queryText:queryText}, function(data) {
                ...
                for(var i = 0; i < data.length; i++) {
                    msg = msg + "<tr>"
                               ...
                               + "<td><a href='/lab8/index.php/Home/Index/edit?id=" + data[i].id + "'>修改</a></td>"
                               + "</tr>";
                }
                msg = msg + "</table>";
                $('#content').html(msg);
